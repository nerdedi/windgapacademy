...
echo -e "Application root: ${YELLOW}http://localhost:4000/${NC}"
echo -e "SPA routes (examples): ${YELLOW}http://localhost:4000/animation-demo${NC} ${YELLOW}http://localhost:4000/tools/fluid-simulation${NC}"
echo ""
