...
export default function AppRouter() {
  return (
    <Router>
      <nav aria-label="Simulation Areas" style={{ marginBottom: '1rem', padding: '1rem', background: '#e3e3e3', borderRadius: '8px', display: 'flex', gap: '1rem', justifyContent: 'center' }}>
        <a href="/supermarket" style={{ textDecoration: 'none', fontWeight: 'bold' }}>Supermarket</a>
        <a href="/clubhouse" style={{ textDecoration: 'none', fontWeight: 'bold' }}>Clubhouse</a>
        <a href="/kitchen" style={{ textDecoration: 'none', fontWeight: 'bold' }}>Kitchen</a>
        <a href="/calmspace" style={{ textDecoration: 'none', fontWeight: 'bold' }}>CalmSpace</a>
        <a href="/zoo" style={{ textDecoration: 'none', fontWeight: 'bold' }}>Zoo</a>
      </nav>
      <Routes>
