  ...
  subscribeWithSelector((set, get) => ({
    ...
    getAnimationStats: () => {
      ...
      return {
        ...
        averageDuration:
          animationHistory.reduce((sum, anim) => sum + anim.duration, 0) / animationHistory.length,
      };
    },
    ...
    getStudentInsights: (studentId) => {
      ...
      return {
        ...
        averageScore: studentModules.reduce((sum, m) => sum + m.score, 0) / studentModules.length,
