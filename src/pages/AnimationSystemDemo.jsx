      ...
      <div style={{ 
        ...
        <section>
          ...
          <ol style={{ lineHeight: '1.6' }}>
            <li>
              <strong>Automatic Setup:</strong> The Unity Animation System Extension automatically adds all necessary
              components to your character models in Unity.
            </li>
            <li>
              <strong>React Integration:</strong> The EnhancedCharacterAnimationController component provides a UI
              for controlling animations from React.
            </li>
            <li>
              <strong>No Manual Configuration:</strong> You don't need to manually add any components or write any
              C# code in Unity.
            </li>
          </ol>
        </section>
        ...
        <section>
          ...
          <p>
            Use the controls below to animate the characters. These controls interact with the Unity Animation System
            Extension through the UnityAnimationBridge.
          </p>
        ...
        <section>
          ...
          <ol style={{ lineHeight: '1.6' }}>
            <li>
              Import the Unity Animation System Extension scripts into your Unity project.
            </li>
            <li>
              In Unity, go to <code>Windgap Academy {'>'}  Animation System {'>'}  Setup Wizard</code>
            </li>
            <li>
              Select your character models and click "Setup Animation System"
            </li>
            <li>
              That's it! The extension will automatically add all necessary components and set up
