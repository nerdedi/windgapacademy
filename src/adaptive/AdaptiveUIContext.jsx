...
export const AdaptiveUIProvider = ({ children }) => {
  ...
  const getAdaptedComponents = useCallback((componentType, options = {}) => {
  ...
  const getAdaptiveClasses = useCallback((baseClass = "") => {
  ...
  }, [colorScheme, layoutDensity, fontSize, motionReduced, contrastEnhanced, focusMode, uiComplexity]);
  ...
  return (
    <AdaptiveUIContext.Provider value={contextValue}>
      <div className={getAdaptiveClasses("adaptive-ui-root")}>
        {children}
      </div>
