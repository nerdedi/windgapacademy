    ...
    >
      <div
        ...
        style={{
          ...
          height: "100vh",
          zIndex: -1,
          background: "url('/assets/backgrounds/avatarbuilder-bg.svg') center/cover no-repeat",
        }}
      ></div>
      ...
      <div className="col-span-4 flex items-center justify-between mb-4">
        ...
        <div
          className="live-preview-window rounded-xl shadow-lg bg-gradient-to-br from-yellow-100 to-blue-100 flex items-center justify-center"
      ...
      <aside className="col-span-1 flex flex-col gap-4">
        <motion.div
          className="feature-card bg-white rounded shadow p-4"
      ...
      <main className="col-span-2 flex flex-col items-center justify-center">
        <motion.div
          ...
          className="drag-drop-area bg-gray-100 rounded shadow p-4"
      ...
      <aside className="col-span-1 flex flex-col gap-4">
        <motion.div
          className="color-picker bg-white rounded shadow p-4"
          whileHover={{ scale: 1.05 }}
        >
          Colour Pickers
        </motion.div>
        <motion.div
          className="unlockable-packs bg-white rounded shadow p-4 mt-4"
          whileHover={{ scale: 1.05 }}
        >
          Unlockable Style Packs
        </motion.div>
      </aside>
