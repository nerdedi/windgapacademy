...
Command: npx gltfjsx@6.5.3 /workspaces/windgapacademy/backend/api/citypack/unpacked/Adventurer.glb -o /workspaces/windgapacademy/components/CityPackModels/Adventurer.jsx 
*/
...
export function Model(props) {
  ...
  const { scene, animations } = useGLTF("/Adventurer.glb");
