...
Command: npx gltfjsx@6.5.3 /workspaces/windgapacademy/backend/api/citypack/unpacked/White Horse.glb -o /workspaces/windgapacademy/components/CityPackModels/White Horse.jsx 
*/
...
export function Model(props) {
  ...
  const { scene, animations } = useGLTF("/White Horse.glb");
...
useGLTF.preload("/White Horse.glb");
