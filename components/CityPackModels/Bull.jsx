...
Command: npx gltfjsx@6.5.3 /workspaces/windgapacademy/backend/api/citypack/unpacked/Bull.glb -o /workspaces/windgapacademy/components/CityPackModels/Bull.jsx 
*/
...
export function Model(props) {
  ...
  const { scene, animations } = useGLTF("/Bull.glb");
