...
export function getAvatarState(features = {}) {
  return {
    ...
    hair: features.hair,
    hairColour: features.hairColour,
    hairStyle: features.hairStyle,
    hairLength: features.hairLength,
    hairTexture: features.hairTexture,
    hairParting: features.hairParting,
    facialHair: features.facialHair,
    facialHairColour: features.facialHairColour,
    facialHairStyle: features.facialHairStyle,
    glasses: features.glasses,
    glassesColour: features.glassesColour,
    headwear: features.headwear,
    headwearColour: features.headwearColour,
    earrings: features.earrings,
    earringsColour: features.earringsColour,
    clothing: features.clothing,
    clothingColour: features.clothingColour,
    clothingStyle: features.clothingStyle,
    clothingGraphic: features.clothingGraphic,
    clothingGraphicColour: features.clothingGraphicColour,
    body: features.body,
    bodyType: features.bodyType,
    bodyColour: features.bodyColour,
    outfit: features.outfit,
    outfitColour: features.outfitColour,
    outfitStyle: features.outfitStyle,
    outfitGraphic: features.outfitGraphic,
    outfitGraphicColour: features.outfitGraphicColour,
