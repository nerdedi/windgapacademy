...
export class AvatarCreator {
  ...
  attachEvents() {
    ...
    if (skinTone)
      skinTone.addEventListener("input", (e) => {
    ...
    if (mouthSelect)
      mouthSelect.addEventListener("change", (e) => {
    ...
    if (outfitPatternSelect)
      outfitPatternSelect.addEventListener("change", (e) => {
    ...
    if (shoesSelect)
      shoesSelect.addEventListener("change", (e) => {
  ...
  renderGallery() {
    ...
    galleryDiv.innerHTML =
      '<h3 class="text-xl font-bold mb-2">Avatar Gallery</h3>' +
      this.gallery
        .map(
          (avatar, idx) => `
